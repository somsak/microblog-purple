 ...
 *
 * not work for now. Pidgin didn't pass the name of user who generate the message
 */
/*
gboolean twitgin_on_displaying(PurpleAccount * account, const char * who, char ** msg, PurpleConversation * conv, PurpleMessageFlags flags)
{
	...
	purple_debug_info("twitgin", "data being displayed = %s, from = %s\n", (*msg), who);
	if(is_twitter_conversation_ma(ma) ) {
